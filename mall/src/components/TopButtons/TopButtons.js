...
function TopButtons({setButtonType, label}){
...
return(<>
    ...
    <span>{label === undefined ? "전체" : label[0]}</span>
    </button>
    ...
    <span>{label === undefined ? "상품": label[1]}</span>
    </button>
    ...
    <span>{label === undefined  ? "카테고리": label[2]}</span>
    </button>
